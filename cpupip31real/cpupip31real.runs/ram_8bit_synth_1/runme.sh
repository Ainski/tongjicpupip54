...
HD_PWD='E:/Homeworks/cpu31real/cpupip31real/cpupip31real.runs/ram_8bit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_8bit.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ram_8bit.tcl
